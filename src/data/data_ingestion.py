...
from src.logger import logging  # Now it should work
...
def main():
    try:
        ...
        df = load_data(data_url='https://raw.githubusercontent.com/rushikeshnayakavadi/Datasets/refs/heads/main/data.csv')
